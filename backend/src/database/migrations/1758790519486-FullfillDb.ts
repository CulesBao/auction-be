...
export class FullfillDb1758790519486 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "bids" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "item_id" uuid NOT NULL, "user_id" uuid NOT NULL, "price" numeric(10,2) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_7950d066d322aab3a488ac39fe5" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "bids" ADD CONSTRAINT "FK_344cb5be90a4b52d41be49d43de" FOREIGN KEY ("item_id") REFERENCES "items"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "items" ADD CONSTRAINT "FK_67b422c7092117ecbb3bba52559" FOREIGN KEY ("winner_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "items" DROP CONSTRAINT "FK_67b422c7092117ecbb3bba52559"`);
        ...
        await queryRunner.query(`ALTER TABLE "bids" DROP CONSTRAINT "FK_344cb5be90a4b52d41be49d43de"`);
